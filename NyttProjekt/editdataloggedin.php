<!-- Visar det valda inlägget och redigerar -->
...
$sql = "SELECT * FROM content WHERE id = '$_GET[id]' ORDER BY id DESC";
...
<div class="card">
  ...
  <div class="card-body text-center">
     <textarea class="form-control" rows="10" name="text" value="'.$row['text'].'">'.$row['text'].'</textarea>
