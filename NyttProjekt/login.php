...
<html lang="sv">
  ...
  <h1 class="display-4">Logga in</h1>
  <p class="lead">Har du inget konto? Registrera <a href="register.php" >här</a></p>
</div>
            <form id="myForm" method="post" action="loginform.php" onsubmit="validateForm();">
  ...
  <button type="submit" class="btn btn-primary">Logga in</button>
    ...
    <!-- Validerings Script -->
<script src="javascript/valideringlogin.js"></script>
